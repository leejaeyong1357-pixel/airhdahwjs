...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "테크젠 AX LAB" },
      { name: "description", content: "테크젠 AX LAB — 104개의 아이디어를 고도화해 실제 업무의 변화로 연결합니다." },
      { property: "og:title", content: "테크젠 AX LAB" },
      { property: "og:description", content: "테크젠 AX LAB — 104개의 아이디어를 고도화해 실제 업무의 변화로 연결합니다." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "테크젠 AX LAB" },
      { name: "twitter:description", content: "테크젠 AX LAB — 104개의 아이디어를 고도화해 실제 업무의 변화로 연결합니다." },
    ],
    links: [
